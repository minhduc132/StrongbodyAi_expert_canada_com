...
const PageHeader = ({ title, description, breadcrumb }: PageHeaderProps) => {
    return (
        <section className="relative pt-32 pb-20 overflow-hidden" style={{ background: 'var(--brand-gradient)' }}>
            ...
            <Container className="relative z-10 text-center">
                <Reveal>
                    <nav className="flex justify-center mb-6">
                        <ol className="flex items-center space-x-2 text-sm font-medium text-white/80 uppercase tracking-widest">
                            <li>Home</li>
