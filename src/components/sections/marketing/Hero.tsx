...
const stats = [
    { icon: <ShieldCheck size={20} className="text-emerald-500" />, val: "500+", label: "Verified Professionals" },
    { icon: <Stethoscope size={20} className="text-blue-500" />, val: "20+", label: "Medical Specialties" },
    { icon: <Map size={20} className="text-teal-500" />, val: "15", label: "States Covered" },
    { icon: <Activity size={20} className="text-violet-500" />, val: "98%", label: "Dispute-Free Transactions" },
];

const partners = [
    { name: "Mayo Clinic", icon: <CheckCircle2 size={16} className="text-blue-700" /> },
    { name: "JOHNS HOPKINS", icon: <CheckCircle2 size={16} className="text-blue-900" /> },
    { name: "Mount Sinai", icon: <CheckCircle2 size={16} className="text-indigo-600" /> },
];
            ...
            <Container className="w-full pt-32 pb-20 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-start text-left">
                    ...
                    <div className="max-w-2xl px-2">
                        <Reveal>
                            {/* Live Badge */}
                            <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-100 text-emerald-700 px-4 py-1.5 rounded-full text-xs font-bold mb-8 shadow-sm">
                            ...
                            <h1 className="text-4xl lg:text-[3.5rem] font-black text-slate-900 tracking-tight leading-[1.1] mb-2">
                                StrongBody <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">AI</span> <span className="text-slate-500 font-bold">us</span>
                            </h1>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 mb-8">
                                <Link
                                    href="/services"
                                    className="bg-primary text-white px-8 py-4 rounded-2xl text-[15px] font-bold transition-all shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-0.5 flex items-center justify-center gap-2"
                                >
                                    Explore Services in the US <ArrowRight size={18} />
                                </Link>
                                <Link
                                    href="/for-partners"
                                    className="bg-violet-600 text-white px-8 py-4 rounded-2xl text-[15px] font-bold transition-all shadow-lg shadow-violet-500/20 hover:shadow-violet-500/35 hover:-translate-y-0.5 flex items-center justify-center gap-2"
                                >
