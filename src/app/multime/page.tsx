            ...
            <section className="relative py-20">
                ...
                <Container>
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <Reveal>
                            <span className="text-primary font-black tracking-widest text-xs uppercase mb-4 block">MultiMe AI Super App</span>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="https://apps.apple.com/us/app/multime-ai/id6748796219" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-slate-800 transition-all shadow-xl">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.multime.app.prod" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-slate-900 text-white px-8 py-4 rounded-2xl font-bold hover:bg-slate-800 transition-all shadow-xl">
                        ...
                        <div className="relative">
                            <ScaleIn>
                                <div className="relative z-10 mx-auto w-[280px] h-[580px] bg-slate-900 rounded-[3rem] border-[8px] border-slate-800 shadow-2xl overflow-hidden">
                                    <div className="absolute top-0 inset-x-0 h-6 bg-slate-800 rounded-b-xl mx-auto w-1/3 z-20"></div>
                                    <img
            ...
            <section className="py-24 bg-slate-50">
                <Container>
                    <div className="text-center mb-16">
                        <Reveal>
                            <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">Inside the MultiMe AI App</h2>
                            <p className="text-slate-500 font-medium">Everything you need for your global health journey.</p>
                        </Reveal>
                    </div>
                ...
                <Container>
                    <div className="bg-primary rounded-[3rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-primary/30">
                        ...
                        <div className="relative z-10">
                            <h2 className="text-3xl md:text-5xl font-black mb-6">Experience the future today.</h2>
                            ...
                            <div className="flex flex-wrap justify-center gap-6">
                                <Link
                                    ...
                                    className="bg-white text-primary px-8 py-4 rounded-2xl font-black hover:bg-slate-50 transition-all flex items-center gap-2"
                                >
